-file("/home/federico/.kerl/20.0/lib/parsetools-2.1.5/include/leexinc.hrl", 0).
...
-file("./acid_lexer.xrl", 48).

-file("/home/federico/.kerl/20.0/lib/parsetools-2.1.5/include/leexinc.hrl", 14).
...
yystate(63, [10|Ics], Line, Tlen, _, _) ->
    yystate(63, Ics, Line+1, Tlen+1, 18, Tlen);
yystate(63, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(63, Ics, Line, Tlen+1, 18, Tlen);
...
yystate(61, [95|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(61, [87|Ics], Line, Tlen, Action, Alen) ->
...
yystate(61, [71|Ics], Line, Tlen, Action, Alen) ->
...
yystate(61, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(63, Ics, Line, Tlen+1, Action, Alen);
yystate(61, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(61, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 101 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(61, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 113 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(61, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(56, [85|Ics], Line, Tlen, Action, Alen) ->
...
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(55, Ics, Line, Tlen+1, 18, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(55, Ics, Line, Tlen+1, 18, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(55, Ics, Line, Tlen+1, 18, Tlen);
yystate(55, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(55, Ics, Line, Tlen+1, 18, Tlen);
...
yystate(39, Ics, Line, Tlen, _, _) ->
    {15,Tlen,Ics,Line,39};
yystate(38, [87|Ics], Line, Tlen, Action, Alen) ->
...
yystate(35, Ics, Line, Tlen, _, _) ->
    {17,Tlen,Ics,Line,35};
yystate(34, [79|Ics], Line, Tlen, Action, Alen) ->
...
yystate(33, Ics, Line, Tlen, _, _) ->
    {16,Tlen,Ics,Line,33};
yystate(32, [87|Ics], Line, Tlen, Action, Alen) ->
...
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(35, Ics, Line, Tlen+1, Action, Alen);
yystate(31, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 123 ->
    yystate(35, Ics, Line, Tlen+1, Action, Alen);
yystate(31, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,31};
yystate(30, [82|Ics], Line, Tlen, Action, Alen) ->
...
yystate(25, Ics, Line, Tlen, _, _) ->
    {16,Tlen,Ics,Line,25};
yystate(24, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(22, [89|Ics], Line, Tlen, Action, Alen) ->
...
yystate(20, Ics, Line, Tlen, _, _) ->
    {8,Tlen,Ics,Line};
yystate(19, [67|Ics], Line, Tlen, Action, Alen) ->
...
yystate(18, [72|Ics], Line, Tlen, Action, Alen) ->
...
yystate(1, [72|Ics], Line, Tlen, Action, Alen) ->
...
-file("./acid_lexer.xrl", 23).
yyaction_0(TokenLine) ->
     { token, { new, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("./acid_lexer.xrl", 24).
yyaction_1(TokenLine) ->
     { token, { put, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("./acid_lexer.xrl", 25).
yyaction_2(TokenLine) ->
     { token, { get, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./acid_lexer.xrl", 26).
yyaction_3(TokenLine) ->
     { token, { retry, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("./acid_lexer.xrl", 27).
yyaction_4(TokenLine) ->
     { token, { throw, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("./acid_lexer.xrl", 28).
yyaction_5(TokenLine) ->
     { token, { 'try', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./acid_lexer.xrl", 29).
yyaction_6(TokenLine) ->
     { token, { 'catch', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./acid_lexer.xrl", 30).
yyaction_7(TokenLine) ->
     { token, { while, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("./acid_lexer.xrl", 31).
yyaction_8(TokenLine) ->
     { token, { 'if', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("./acid_lexer.xrl", 32).
yyaction_9(TokenLine) ->
     { token, { then, TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("./acid_lexer.xrl", 33).
yyaction_10(TokenLine) ->
     { token, { else, TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("./acid_lexer.xrl", 34).
yyaction_11(TokenLine) ->
     { token, { 'or', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("./acid_lexer.xrl", 36).
yyaction_12(TokenLine) ->
     { token, { true, TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("./acid_lexer.xrl", 37).
yyaction_13(TokenLine) ->
     { token, { false, TokenLine } } .

-compile({inline,yyaction_14/2}).
-file("./acid_lexer.xrl", 39).
yyaction_14(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_15/2}).
-file("./acid_lexer.xrl", 40).
yyaction_15(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_16/2}).
-file("./acid_lexer.xrl", 41).
yyaction_16(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_17/2}).
-file("./acid_lexer.xrl", 43).
yyaction_17(TokenChars, TokenLine) ->
     { token, { tvar, TokenLine, tl (TokenChars) ++ "." } } .

-compile({inline,yyaction_18/0}).
-file("./acid_lexer.xrl", 44).
yyaction_18() ->
     skip_token .

-file("/home/federico/.kerl/20.0/lib/parsetools-2.1.5/include/leexinc.hrl", 309).
